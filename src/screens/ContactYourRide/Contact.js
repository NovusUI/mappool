...
const Contact = ({type})=>{
   ...
   const joinCarpoolGroup = ()=>{
    window.open(carpoolWhatsAppLink, '_blank');
   }
    ...
    return(
      ...
      <div className="container">
       ...
       
        {
          type === 'carpool' &&
          <>
          <button className={(carPoolFound && isPoolGroupCreated) ? "group-btn":"inactive"}  disabled={!carPoolFound && !isPoolGroupCreated } onClick={joinCarpoolGroup}>
